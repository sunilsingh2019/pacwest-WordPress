...
function recipe_replace_repeater_field( $where ) {
     $where = str_replace( "meta_key = 'recipe_pacwest_products_$", "meta_key LIKE 'recipe_pacwest_products_%", $where );
     return $where;
}
add_filter( 'posts_where', 'recipe_replace_repeater_field' );
...
?>
    ...
    <div class="item hvr-bob <?php echo $cat_classes;?>"> 
